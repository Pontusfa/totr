...
obj.peers = [
  {
    name: 'All OK #1'
    peer:
      peer_id: 'a', infoHash: 'true' , ip: '173.194.40.232', port: 3133, passkey: 'true'
  ...
  },
  {
    name: 'All OK #2'
    peer:
      peer_id: null, infoHash: 'true' , ip: '173.194.40.232', port: 3133, passkey: 'true'
    error: errors.NOERROR
    valid: yes
  },
  {
    ...
    peer:
      peer_id: 'a', infoHash: 'no' , ip: '173.194.40.232', port: 3133, passkey: 'true'
  ...
  },
  {
    ...
    peer:
      peer_id: 'a', infoHash: null , ip: '173.194.40.232', port: 3133, passkey: 'true'
    error: errors.BADINFOHASH
    valid: no
  },
  {
  ...
  },
  {
    name: 'Bad IP #2'
    peer:
      peer_id: 'a', infoHash: 'true' , ip: null, port: 3313, passkey: 'true'
    error: errors.BADIP
    valid: no
  },
  {
    name: 'Bad IP #3'
    peer:
      peer_id: 'a', infoHash: 'true' , ip: '127.0.0.1', port: 3133, passkey: 'true'
    error: errors.BADIP
    valid: no
  },
  {
    name: 'Bad Port #1'
    peer:
      peer_id: 'a', infoHash: 'true' , ip: '173.194.40.232', port: 333, passkey: 'true'
  ...
  },
  {
    name: 'Bad Port #2'
    peer:
      peer_id: 'a', infoHash: 'true' , ip: '173.194.40.232', port: 2^16+1, passkey: 'true'
    error: errors.BADPORT
    valid: no
  },
  {
    name: 'Bad Passkey'
    peer:
      peer_id: 'a', infoHash: 'true' , ip: '173.194.40.232', port: 3133, passkey: 'noPasskey'
  ...
  },
  {
    name: 'Banned User'
    peer:
      peer_id: 'a', infoHash: 'true' , ip: '173.194.40.232', port: 3133, passkey: 'banned'
  ...
  },
  {
    name: 'Inactive User'
    peer:
      peer_id: 'a', infoHash: 'true' , ip: '173.194.40.232', port: 3133, passkey: 'inactive'
